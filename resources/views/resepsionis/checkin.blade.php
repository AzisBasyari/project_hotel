...
@section('content')
    ...
    <div class="mb-3">
        <form action="/resepsionis/checkin" method="get">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-1">
                    <a href="/resepsionis/checkin" role="button" class="btn btn-secondary rounded-pill px-5">
        ...
        <tr>
            ...
            <td>
                <form action="/reservasi/{{ $reservasi->id }}" method="post">
                    @csrf
                    @method('put')
                    <button type="submit" class="btn btn-secondary rounded-pill px-3 py-1" name='status' value="checkout">
                        Check Out
                    </button>
                </form>
            </td>
